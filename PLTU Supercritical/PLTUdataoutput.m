...
for Loop=1:DataVariasi,
    ...
    if Loop == 1,
        EfficiencyBoilerGA1 = num2str(EffBoiler);
        EfficiencyThermalGA1 = num2str(EffThermal);
        TurbinHeatRateGA1 = num2str(THRdlmKcalperKwh);
        GrossPlantHeatRateGA1 = num2str(GPHRdlmKcalperKwh);
    elseif Loop == 2,
        EfficiencyBoilerGA2 = num2str(EffBoiler);
        EfficiencyThermalGA2 = num2str(EffThermal);
        TurbinHeatRateGA2 = num2str(THRdlmKcalperKwh);
        GrossPlantHeatRateGA2 = num2str(GPHRdlmKcalperKwh);
    elseif Loop == 3,
        EfficiencyBoilerGA3 = num2str(EffBoiler);
        EfficiencyThermalGA3 = num2str(EffThermal);
        TurbinHeatRateGA3 = num2str(THRdlmKcalperKwh);
        GrossPlantHeatRateGA3 = num2str(GPHRdlmKcalperKwh);
    elseif Loop == 4,
        EfficiencyBoilerGA4 = num2str(EffBoiler);
        EfficiencyThermalGA4 = num2str(EffThermal);
        TurbinHeatRateGA4 = num2str(THRdlmKcalperKwh);
        GrossPlantHeatRateGA4 = num2str(GPHRdlmKcalperKwh);
     elseif Loop == 5,
        EfficiencyBoilerGA5 = num2str(EffBoiler);
        EfficiencyThermalGA5 = num2str(EffThermal);
        TurbinHeatRateGA5 = num2str(THRdlmKcalperKwh);
        GrossPlantHeatRateGA5 = num2str(GPHRdlmKcalperKwh);
    end
end
...
for Loops=1:DataVariasi,
    ...
    EffBoiler = ((Mass1data*(h1-h26)+Mass6data*(h6-h5))/(Mfuel*GCVdata))*100;
    EffThermal = ((WtperMassadata)/(Qboiler+Qreheater))*100;
    GPHRdlmKcalperKwh = THRdlmKcalperKwh/(EffBoiler/100);
    ...
    if Loops == 1,
        EfficiencyBoilerNorm1 = num2str(EffBoiler);
        EfficiencyThermalNorm1 = num2str(EffThermal);
        TurbinHeatRateNorm1 = num2str(THRdlmKcalperKwh);
        GrossPlantHeatRateNorm1 = num2str(GPHRdlmKcalperKwh);
    elseif Loops == 2,
        EfficiencyBoilerNorm2 = num2str(EffBoiler);
        EfficiencyThermalNorm2 = num2str(EffThermal);
        TurbinHeatRateNorm2 = num2str(THRdlmKcalperKwh);
        GrossPlantHeatRateNorm2 = num2str(GPHRdlmKcalperKwh);
    elseif Loops == 3,
        EfficiencyBoilerNorm3 = num2str(EffBoiler);
        EfficiencyThermalNorm3 = num2str(EffThermal);
        TurbinHeatRateNorm3 = num2str(THRdlmKcalperKwh);
        GrossPlantHeatRateNorm3 = num2str(GPHRdlmKcalperKwh);
    elseif Loops == 4,
        EfficiencyBoilerNorm4 = num2str(EffBoiler);
        EfficiencyThermalNorm4 = num2str(EffThermal);
        TurbinHeatRateNorm4 = num2str(THRdlmKcalperKwh);
        GrossPlantHeatRateNorm4 = num2str(GPHRdlmKcalperKwh);
     elseif Loops == 5,
        EfficiencyBoilerNorm5 = num2str(EffBoiler);
        EfficiencyThermalNorm5 = num2str(EffThermal);
        TurbinHeatRateNorm5 = num2str(THRdlmKcalperKwh);
        GrossPlantHeatRateNorm5 = num2str(GPHRdlmKcalperKwh);
    end
end
